...
/*!*********************!*\
  !*** ./src/face.js ***!
  \*********************/
/*! exports provided: drawSquare, default */
...
/* harmony import */ var tracking__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tracking */ "./node_modules/tracking/build/tracking.js");
/* harmony import */ var tracking__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(tracking__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var tracking_build_data_face_min__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tracking/build/data/face-min */ "./node_modules/tracking/build/data/face-min.js");
/* harmony import */ var tracking_build_data_face_min__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(tracking_build_data_face_min__WEBPACK_IMPORTED_MODULE_1__);
...
function isZooming() {
  ...
  var hDiff = history[0].height - history[len].height;
  var wDiff = history[0].width - history[len].width;
  console.log({
    hDiff: hDiff,
    wDiff: wDiff
  });
...
function drawSquare() {
  ...
  var context = canvas.getContext('2d');
  var tracker = new tracking.ObjectTracker('face'); // tracker.setInitialScale(4);
  ...
  tracker.on('track', function (event) {
    ...
    event.data.forEach(function (rect) {
      ...
      context.fillText("x: ".concat(rect.x, "px"), rect.x + rect.width + 5, rect.y + 11);
      context.fillText("y: ".concat(rect.y, "px"), rect.x + rect.width + 5, rect.y + 22);
    });
...
var highlightLinks = function highlightLinks() {
  ...
  _toConsumableArray(links).forEach(function (link, idx) {
...
document.addEventListener('DOMContentLoaded', function () {
  injectStyle();
  highlightLinks();
  _face__WEBPACK_IMPORTED_MODULE_0__["default"].drawSquare();
});
...
/******/ });
//# sourceMappingURL=webres.min.js.map